...
DATABASES = {
    'default': {
        ...
        'HOST': env('POSTGRES_HOST'),  # Use 'postgres' when running in Docker
        'PORT': env('POSTGRES_DOCKER_PORT'),
    }
}
...
CACHES = {
    'default': {
        ...
        'LOCATION': f"redis://{env('REDIS_HOST')}:{env('REDIS_DOCKER_PORT')}/1",  # Use 'redis://redis:6379/1' when running in Docker
        'OPTIONS': {
